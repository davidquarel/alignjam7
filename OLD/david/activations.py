...
import utils, arch, mnist_poison
...
dict = torch.load("models/clean_0000.pt")
...
def all_channels(module):
    ...
    height, width = utils.closest_factors(num_channels)

    fig, axs = plt.subplots(height, width, figsize=(40, 40))
    axs = axs.flatten()
